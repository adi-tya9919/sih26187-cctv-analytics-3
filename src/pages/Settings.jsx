      ...
      <div className="mx-auto max-w-3xl space-y-5">
        <section className="rounded-xl border border-surface-border bg-white shadow-card">
          <div className="flex items-center gap-3 border-b border-surface-border px-5 py-4">
            ...
            <div>
              <h2 className="text-sm font-semibold text-black">Officer Profile</h2>
        ...
        <section className="rounded-xl border border-surface-border bg-white shadow-card">
          <div className="flex items-center gap-3 border-b border-surface-border px-5 py-4">
            ...
            <div>
              <h2 className="text-sm font-semibold text-gray-500">Console Preferences</h2>
        ...
        <section className="rounded-xl border border-surface-border bg-white shadow-card">
          <div className="flex items-center gap-3 border-b border-surface-border px-5 py-4">
            ...
            <div>
              <h2 className="text-sm font-semibold text-gray-500">Security</h2>
